...
var ShoppingCartComponentComponent = (function () {
    ...
    ShoppingCartComponentComponent.prototype.getGrantTotal = function () {
        ...
        for (var i = 0; i < this.cartItems.length; i++) {
            this.cartItems[i].totalPrice = this.cartItems[i].unitPrice * this.cartItems[i].quantity + +this.cartItems[i].tax;
...
module.exports = "<div class=\"container\">\n    <div class=\"row\">\n        <hr class=\"wedge\">\n    </div>\n</div>\n<div class=\"container-fluid\">\n    <div class=\"panel panel-default\" style=\"border-radius:0px !important\" id=\"{{title}}\">\n        <ul class=\"list-group\">\n            <li class=\"list-group-item\" style=\"background:#F64747;border-radius:0px !important;color:#ffffff\">{{title}}\n                <button class=\"btn btn-xs pull-right\" style=\"background:#F22613\">\n                <span class=\"glyphicon glyphicon-menu-right\"></span>\n                <span class=\"glyphicon glyphicon-menu-right\"></span>\n                <span class=\"glyphicon glyphicon-menu-right\"></span>\n                </button>\n            </li>\n        </ul>\n        <div class=\"row\">\n            <div *ngFor=\"let item of [1,2,3,4]; let i=index\" class=\"col-xs-6 col-sm-3 col-md-3 col-lg-3\" data-placement=\"bottom\" data-toggle=\"popover\" data-content=\"Aligns nav links, forms, buttons, or text, in the navbar to the left\" data-trigger=\"hover\">\n                <div class=\"media padding-2px\">\n                    <div class=\"\" style=\"position:absolute;z-index:5\">\n                        <div class=\"btn-group btn-block\" role=\"group\" aria-label=\"plus-minus\">\n                            <button type=\"button\" class=\"btn btn-sm minus-button merge-top-left-button\" style=\"outline:none;border-radius:50%;border:1px solid #776B5F;color:#F22613\"><span class=\"glyphicon glyphicon-minus\"></span></button>\n                        </div>\n                        <input type=\"text\" value=\"1\" class=\"input-sm form-control padding-2px\" style=\"width:35px\">\n                        <div class=\"btn-group btn-block\" role=\"group\" aria-label=\"plus-minus\">\n                            <button type=\"button\" class=\"btn btn-sm plus-button merge-top-right-button\" style=\"outline:none;border-radius:50%;border:1px solid #776B5F;color:darkgreen\"><span class=\"glyphicon glyphicon-plus\"></span></button>\n                        </div>\n                    </div>\n                    <div class=\"col-sm-4 col-xs-4 input-lg\" style=\"position:absolute;right: 2px;\">\n                        <span class=\"fa fa-rupee\" style=\"text-decoration:line-through;\">70</span>\n                        <span class=\"fa fa-rupee text-danger\">60</span>\n                    </div>\n                    <div class=\"media-top\" style=\"text-align:center;background:#f0f0f0\">\n                        <img height=\"150px\" width=\"150px\" src=\"{{imageURL}}\" class=\"img-circle\">\n                    </div>\n                    <div class=\"media-body\" style=\"text-align:center;background:#f0f0f0;opacity:.9;margin-top: -70px;float: right;width: auto;\">\n                        <h4 class=\"media-heading\">Title</h4>\n                        <p>Aligns nav links, forms, buttons, or text, in the navbar to the left</p>\n                    </div>\n                    <div class=\"col-sm-12 col-xs-12 input-group text-center\" style=\"z-index:5;background:#d9d4ce;\">\n                        <div class=\"col-sm-6 col-xs-6 padding-2px\">\n                            <span class=\"glyphicon glyphicon-star\" style=\"vertical-align:bottom;\"></span>\n                            <span class=\"glyphicon glyphicon-star\" style=\"vertical-align:bottom;\"></span>\n                            <span class=\"glyphicon glyphicon-star\" style=\"vertical-align:bottom;\"></span>\n                        </div>\n                        <!--    <input id=\"rating-system\" type=\"number\" class=\"rating\" min=\"1\" max=\"5\" step=\"1\" value=\"3\">-->\n\n                        <button class=\"col-sm-6 col-xs-6 btn icon-btn btn-success\" href=\"#\">\n                            <span class=\"glyphicon btn-glyphicon glyphicon-plus img-circle text-success\">\n                            </span> Add\n                        </button>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"
